...
export type SystemMonitorSnapshot = {
  ...
  gpu: GpuMonitor;
  comfySystem: unknown | null;
  queue: ReturnType<typeof getSchedulerSystemState>;
};
...
export const getSystemMonitorSnapshot = async (): Promise<SystemMonitorSnapshot> => {
